### FROM https://github.com/lyft/nuscenes-devkit BY Vladimir Iglovikov (https://github.com/ternaus)
...
if __name__ == "__main__":
    ...
    arg("-o", "--output_file", type=str, help="to store eval result", default=None)
